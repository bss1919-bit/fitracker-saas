            ...
            <div className="w-full max-w-md space-y-8 relative z-10">
                ...
                <Card className="w-full bg-slate-900 border-slate-800 text-slate-100 rounded-[2.5rem] shadow-2xl shadow-black/50 border-2 border-indigo-500/5 p-2 overflow-hidden">
                    <CardHeader className="p-8 pb-4 space-y-2">
                        <CardTitle className="text-3xl font-black text-center text-white tracking-tight">{t('loginTitle')}</CardTitle>
                    ...
                    <CardContent className="p-8 pt-4">
                        ...
                        <div className="mt-8 text-center">
                            <Link href="/auth/register" className="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-indigo-400 transition-all">
                                {t('noAccount')}
                            </Link>
                        </div>
                    </CardContent>
